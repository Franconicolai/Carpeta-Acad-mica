...
* **Temporalidad y Vigencia:** Los contenidos reflejan el estado del programa en el periodo específico en que cursé cada asignatura. Los temarios, requisitos y evaluaciones pueden haber cambiado, por lo que este material debe tomarse como una referencia histórica y no como una regla definitiva.
* **Proceso de Aprendizaje (¡Tómenlo con lupa!):** Todos los documentos, respuestas, tareas y casos resueltos son parte de mi proceso de aprendizaje y no implican que estén 100% correctos. Hubo errores y fracasos que fueron parte vital de este camino; por lo tanto, revisen el material con criterio analítico y no asuman que todo está perfecto.
* **Estructura Interna de las Carpetas:** En general, la mayoría de los ramos siguen una organización estándar que incluye:
  * **Prospecto:** El programa oficial del curso.
  * **Pruebas:** Controles o evaluaciones (en caso de haberlas tenido).
  * **Tareas:** Trabajos y entregas personales.
...
* IIC100G En Búsqueda del Bienestar: ¿Qué Nos Dice la Ciencia?
...
## 📈 Especialización y Ramos Complementarios

Estudié en paralelo materias de otras facultades. Este contenido está pensado como una aclaración y recurso invaluable para cualquier persona que quiera especializarse más en el área de negocios y empresa, ya que sirve como un excelente complemento a los ramos de ingeniería.
...
* EAA2240 Contabilidad Gerencial
* EAA2310 Fundamentos del Marketing
* EAA2320 Marketing Analytics
* EAA2410 Contabilidad de los Costos
* EAA2410 Estrategia de la Organización
...
* EAE2110 Microeconomía I
* EAE2120 Microeconomía II
* EAE2130 Competencia y Mercado
...
* OPR Estrategia de Canales de Distribución y Omnicanalidad
* OPR Finanzas Internacionales
* OPR Psicología
...
Este repositorio es un archivo estrictamente personal de respaldo y organización de apuntes académicos. Su propósito es de índole estrictamente educacional y de libre acceso para consulta.

* **Sin fines de lucro:** Este material no posee ningún fin comercial ni de monetización.
* **Dominio y autoría:** Los contenidos, apuntes y estructuras recopiladas no tienen derechos de autor restrictivos por mi parte; se comparten bajo una política de uso libre y personal ("el que logre tener acceso a esto, bendito sea").
