...
```
1. `"{NOMBRE APELLIDO}"` debes cambirlo por tu nombre y apellido, por ejemplo, "Pepa Tortuga"
2. `"{CORREO CUENTA GITHUB}"` debe ser tu correo, por ejemplo, "pepa@iic2233.aan".
